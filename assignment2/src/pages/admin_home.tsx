...
const Admin_home = () => {
    ...
    return <>
        <div className="overflow-x-auto rounded-lg border border-gray-200">
            <table className="table-auto min-w-full divide-y-2 divide-gray-200 text-sm">
                <thead>
                    <tr>
                        <th
                    ...
                    {products.map(product => (
                        <tr>
                            ...
                            <td className="text-center">
                                <button className="bg-red-600 text-white rounded-md p-2 " onClick={() => RemovebyId(product.id)} data-name="${projects.name}" data-id="${projects.id}">Xoá</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
