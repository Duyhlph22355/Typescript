                    ...
                    <form className="space-y-4 lg:pt-8">
                        <fieldset>
                            ...
                            <div className="flex items-center justify-between">
                                <span className="text-3xl font-bold text-red-500 dark:text-white ">{product.price} ₫</span>
                                <span className="text-sm font-bold text-gray-400 dark:text-white ">{product.original_price} ₫</span>
                            </div>
